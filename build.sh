...
mkdir -p /var/opt/OpenCode

dnf install -y /tmp/opencode.rpm

mv /var/opt/OpenCode /usr/share/factory/OpenCode

tee /usr/lib/tmpfiles.d/OpenCode.conf <<'EOF'
L  /opt/OpenCode  -  -  -  -  /usr/share/factory/OpenCode
EOF
